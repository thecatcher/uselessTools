...
class MySshClient:
    ...
    def ssh_login(self, host_ip, username, password):
        try:
            ...
            self.ssh_client.connect(host_ip, port=PORT, username=username, password=password)
...
if __name__ == '__main__':
    ...
    if my_ssh_client.ssh_login(HOST, USERNAME, PASSWD) == 1000:
        logging.warning(f"{HOST}-login success, will execute command：{COMMAND}")
